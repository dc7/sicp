...
; It would be useful to have "unless" as a procedure if you wanted to write
; something like this:
...
(define (map3 f a b c)
  (if (or (null? a) (null? b) (null? c))
    '()
    (cons (f a b c) (map3 f (cdr a) (cdr b) (cdr c)))))

(map3 unless predicates consequences alternatives)
