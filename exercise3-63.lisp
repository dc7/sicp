...
(stream-to-list (stream-take (sqrt-stream 2) 10))
...
; I think this has to do with the many levels of filters applied to the stream. Each filter recalculates the results of all below it.
