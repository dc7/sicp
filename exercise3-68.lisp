...
; In the first version, the stream-map is in the second part of a const-stream, so it is delayed. In the second version, the whole stream t is traversed at each step.
